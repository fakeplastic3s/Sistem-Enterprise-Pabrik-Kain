...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Edit Armada</h4>
        <form action="/Armada/update/<?= $data['plat_nomor']; ?>" method="POST">
            <?= csrf_field(); ?>

            <div class="row mb-3">
                <label for="plat_nomor" class="col-sm-2 col-form-label">Plat Nomor</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control <?= ($validation->hasError('plat_nomor')) ? 'is-invalid' : ''; ?>" id="plat_nomor" name="plat_nomor" value="<?= $data['plat_nomor'] ?>" readonly>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control <?= ($validation->hasError('jenis_kendaraan')) ? 'is-invalid' : ''; ?>" id="jenis_kendaraan" name="jenis_kendaraan" autofocus value="<?= (old('jenis_kendaraan')) ? old('jenis_kendaraan') : $data['jenis_kendaraan']; ?>" autofocus>
                    <div id="validationServer03Feedback" class="invalid-feedback">
