...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Tambah Data Jadwal Perawatan</h4>
        <form action="/JadwalPerawatan/add" method="POST">
            <?= csrf_field(); ?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <select name="status" class="select2_single form-control <?= ($validation->hasError('supplier')) ? 'is-invalid' : ''; ?>" value="<?= old('status'); ?>">
                        <option value="">--Pilih--</option>
