...
<section class="section dashboard">
    ...
    <div class="row ">
        <div class="col-lg-7 col-sm-4 col-md-5 ms-2">
            <a href="<?= base_url('KebutuhanProduksi/tambah'); ?>" class="btn btn-success mb-2"><i class="bi bi-clipboard-plus"></i></a>
            <button onclick="window.print()" class="btn btn-primary mb-2"><i class="ri-printer-line"></i></button>
            <a href="<?= base_url('KebutuhanProduksi'); ?>" class="btn btn-secondary mb-2"><i class="bi bi-arrow-clockwise"></i></a>
        </div>
        <div class="col me-2 pb-3">

            <form class="d-flex" role="search" action="KebutuhanProduksi" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive-md">
                <table class="table table-striped ">
                    ...
                    <tbody>
                        <?php $no = 1 ?>
                        <?php foreach ($getKebutuhanProduksi as $isi) : ?>
                            <tr>
                                <td><?= $no; ?></td>
                                <td class="text-right"><?= $isi['nama_barang']; ?></td>
                                <td class="text-right"><?= $isi['bahan']; ?></td>
                                <td class="text-center">
                                    <a href="<?= base_url('/KebutuhanProduksi/edit/' . $isi['id_kebutuhan_produksi']); ?>" class="btn btn-success btn-sm"><i class="ri-clipboard-line"></i></a>
