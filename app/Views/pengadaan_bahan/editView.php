...
<a href="<?= base_url('PengadaanBahan'); ?>" class="btn btn-secondary mb-2"><i class="bi bi-arrow-left"></i></a>
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Edit Data Bahan Masuk</h4>
        <form action="/PengadaanBahan/update/<?= $pengadaan->id_pengadaan; ?>" method="POST">
            <?= csrf_field(); ?>
