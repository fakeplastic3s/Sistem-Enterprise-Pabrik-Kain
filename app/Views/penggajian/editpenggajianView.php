...
<a href="<?= base_url('penggajian'); ?>" class="btn btn-secondary mb-2"><i class="bi bi-arrow-left"></i></a>
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Edit Data penggajian</h4>
        <form action="/penggajian/update/<?= $penggajian->id_pegawai; ?>" method="POST">
            <?= csrf_field(); ?>
            ...
            <div class="row mb-3">
                <label for="umur" class="col-sm-2 col-form-label">Umur pegawai</label>
                <div class="col-sm-10">
            ...
            <input type="hidden" name="id" value="<?= $penggajian->id_pegawai; ?>">
